...
data class KeytaoImeTheme(
    ...
    val keyPressedBackground: KeytaoColor,
    val keyPressedForeground: KeytaoColor,
    ...
    companion object {
        fun fallback(): KeytaoImeTheme = KeytaoImeTheme(
            ...
            keyPressedBackground = KeytaoColor.rgb(0xD4, 0xE7, 0xFF),
            keyPressedForeground = KeytaoColor.rgb(0x14, 0x23, 0x3B),
        ...
        fun fromJson(json: String?): KeytaoImeTheme {
            ...
            return runCatching {
                ...
                KeytaoImeTheme(
                    ...
                    keyPressedBackground = KeytaoColor.fromJson(candidate?.optJSONObject("pressedBackground"), fallback.keyPressedBackground),
                    keyPressedForeground = KeytaoColor.fromJson(candidate?.optJSONObject("pressedForeground"), fallback.keyPressedForeground),
