...
magick "$INPUT_PNG" -resize 16x16 "$ICONSET/icon_16x16.png"
magick "$INPUT_PNG" -resize 32x32 "$ICONSET/icon_16x16@2x.png"
magick "$INPUT_PNG" -resize 32x32 "$ICONSET/icon_32x32.png"
magick "$INPUT_PNG" -resize 64x64 "$ICONSET/icon_32x32@2x.png"
magick "$INPUT_PNG" -resize 128x128 "$ICONSET/icon_128x128.png"
magick "$INPUT_PNG" -resize 256x256 "$ICONSET/icon_128x128@2x.png"
magick "$INPUT_PNG" -resize 256x256 "$ICONSET/icon_256x256.png"
magick "$INPUT_PNG" -resize 512x512 "$ICONSET/icon_256x256@2x.png"
magick "$INPUT_PNG" -resize 512x512 "$ICONSET/icon_512x512.png"
magick "$INPUT_PNG" -resize 1024x1024 "$ICONSET/icon_512x512@2x.png"
